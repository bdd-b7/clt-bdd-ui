...
//         await helpers.loadPage(page.Ebay.url);
//         await this.inputUserName(username)
//         await this.inputPassword(page.Ebay.elements['PasswordVal'])
//         await this.clickElement('LoginBtn')
//         await driver.sleep(2000); 
//         return;
//     },
//     verifyApproverName: async function(val) {
//         var selector = page.Ebay.elements['approverName'];
//         var result = await driver.findElement(By.xpath(selector)).getAttribute("value");
//         assert.equal(page.Ebay.content[val], result);
//     }
// };
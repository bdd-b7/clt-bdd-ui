...
module.exports = {
    ...
    elements: {
        ...
        HelloVenkataprasad: '//*[@id="nav-link-accountList-nav-line-1"]',
        ReturnsandOrders: '//*[@id="nav-orders"]/span[1]',
        cart: '//*[@id="nav-cart"]',
        YourAmazonCartisempty: '//*[@id="sc-active-cart"]/div/div/div[2]/div[1]/h2',     
        selectAddress: '//*[@id="glow-ingress-block"]',
        chooseyourLocation: '//*[@id="a-popover-header-1"]',
        customerservice: '//*[@id="nav-xshop"]/a[2]',
        welcometoamazoncustomerservice: '//*[@id="hub-gateway-app-unauth"]/div[1]/div/h1',
    },
    content: {
